...
//	out.println(MyCalendar.totalDay(2021, 3, 2) +"<br/>");
//	out.println(MyCalendar.weekDay(2021, 3, 2) +"<br/>");	 
...
<table width="700" align="center" border="1" cellpadding="5" cellspacing="1">
	...
	<tr>
		<th>
			<!-- "?" 뒤에는 절대로 띄어쓰기를 하면 안된다. 정보가 2가지 이상이면 "&"로 구분한다. -->
...
//	1일이 출력될 위치를 맞추기 위해서 1일의 요일만큼 반복하며 빈 칸에 전달 날짜를 출력한다.
	for (int i = 0; i < week; i ++){
		if (i == 0){
